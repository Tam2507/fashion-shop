...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Atino Fashion - Thời Trang Cao Cấp'); ?></title>
...
<nav class="navbar navbar-expand-lg sticky-top">
    <div class="container-fluid px-4">
        <a class="navbar-brand" href="<?php echo e(route('home')); ?>">Fashion Shop</a>
                    ...
                    <?php if(auth()->user()->is_admin): ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end admin-dropdown-menu">
                                ...
                                <li><a class="dropdown-item admin-dropdown-item" href="<?php echo e(route('admin.home')); ?>"><i class="fas fa-home"></i> Admin Home</a></li>
                                <li><a class="dropdown-item admin-dropdown-item" href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-chart-line"></i> Dashboard Thống Kê</a></li>
                                <li><a class="dropdown-item admin-dropdown-item" href="<?php echo e(route('admin.unified')); ?>"><i class="fas fa-tachometer-alt"></i> Dashboard Unified</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li class="dropdown-header admin-section-header">
                                    <i class="fas fa-store"></i> Quản Lý Cửa Hàng
                                </li>
                                <li><a class="dropdown-item admin-dropdown-item" href="<?php echo e(route('admin.products.index')); ?>"><i class="fas fa-box"></i> Sản Phẩm</a></li>
                                <li><a class="dropdown-item admin-dropdown-item" href="<?php echo e(route('admin.categories.index')); ?>"><i class="fas fa-tags"></i> Danh Mục</a></li>
                                <li><a class="dropdown-item admin-dropdown-item" href="<?php echo e(route('admin.orders.index')); ?>"><i class="fas fa-shopping-cart"></i> Đơn Hàng</a></li>
                                <li><a class="dropdown-item admin-dropdown-item" href="<?php echo e(route('admin.users')); ?>"><i class="fas fa-users"></i> Khách Hàng</a></li>
                                <li><a class="dropdown-item admin-dropdown-item" href="<?php echo e(route('admin.admins.index')); ?>"><i class="fas fa-user-shield"></i> Quản Lý Admin</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li class="dropdown-header admin-section-header">
                                    <i class="fas fa-palette"></i> Giao Diện & Cài Đặt
                                </li>
                                <li><a class="dropdown-item admin-dropdown-item" href="<?php echo e(route('admin.banners.index')); ?>"><i class="fas fa-images"></i> Quản Lý Banner</a></li>
                                <li><a class="dropdown-item admin-dropdown-item" href="<?php echo e(route('admin.footer-settings.index')); ?>"><i class="fas fa-cog"></i> Cài Đặt Footer</a></li>
                            </ul>
                        </li>
                    <?php endif; ?>
                    
                    <li class="nav-item">
                        <a href="<?php echo e(route('wishlist.index')); ?>" class="nav-link position-relative" title="Danh sách yêu thích">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle user-dropdown-toggle" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown">
                            <?php if(auth()->user()->avatar): ?>
                                <img src="<?php echo e(asset('storage/' . auth()->user()->avatar)); ?>" alt="Avatar" class="user-avatar-img">
                            <?php else: ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end user-dropdown-menu">
                            <li class="dropdown-header">
                                <div class="user-info-header">
                                    <?php if(auth()->user()->avatar): ?>
                                        <img src="<?php echo e(asset('storage/' . auth()->user()->avatar)); ?>" alt="Avatar" class="user-avatar-large">
                                    <?php else: ?>
                            ...
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item user-dropdown-item" href="<?php echo e(route('profile.edit')); ?>"><i class="fas fa-user-circle"></i> Thông Tin Cá Nhân</a></li>
                            <li><a class="dropdown-item user-dropdown-item" href="<?php echo e(route('orders.index')); ?>"><i class="fas fa-history"></i> Đơn Hàng</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
    ...
    <div class="container">
        <?php if(session('success')): ?>
            <div class="alert alert-success alert-dismissible fade show mt-3" role="alert">
                <i class="fas fa-check-circle"></i> <strong>Thành công!</strong> <?php echo e(session('success')); ?>
        ...
        <?php if(session('error')): ?>
            <div class="alert alert-danger alert-dismissible fade show mt-3" role="alert">
                <i class="fas fa-exclamation-circle"></i> <strong>Lỗi!</strong> <?php echo e(session('error')); ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <h5 class="text-uppercase fw-bold mb-3"><?php echo e($footerSettings->company_name ?? 'Fashion Shop'); ?></h5>
                <?php if($footerSettings): ?>
                    <?php if($footerSettings->company_description): ?>
                        <p class="mb-2"><?php echo e($footerSettings->company_description); ?></p>
                    <?php endif; ?>
                    <?php if($footerSettings->business_license): ?>
                        <p class="mb-1"><?php echo e($footerSettings->business_license); ?></p>
                    <?php endif; ?>
                    <?php if($footerSettings->address): ?>
                        <p class="mb-1">Địa chỉ: <?php echo e($footerSettings->address); ?></p>
                    <?php endif; ?>
                    <?php if($footerSettings->phone): ?>
                        <p class="mb-1">Điện thoại: <strong><?php echo e($footerSettings->phone); ?></strong></p>
                    <?php endif; ?>
                    <?php if($footerSettings->hotline): ?>
                        <p class="mb-1">Hotline: <strong><?php echo e($footerSettings->hotline); ?></strong></p>
                    <?php endif; ?>
                    <?php if($footerSettings->email): ?>
                        <p class="mb-0">Email: <a href="mailto:<?php echo e($footerSettings->email); ?>" class="text-white"><?php echo e($footerSettings->email); ?></a></p>
                    <?php endif; ?>
                <?php else: ?>
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="<?php echo e(route('about')); ?>" class="text-white-50 text-decoration-none">Về Fashion Shop</a></li>
                    <li class="mb-2"><a href="<?php echo e(route('contact')); ?>" class="text-white-50 text-decoration-none">Liên hệ showroom</a></li>
                    <li class="mb-2"><a href="<?php echo e(route('products.index')); ?>" class="text-white-50 text-decoration-none">Sản phẩm</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <?php if($footerSettings && $footerSettings->working_hours): ?>
                    <p class="mb-2"><strong>Giờ làm việc:</strong></p>
                    <p class="mb-2 text-white-50"><?php echo nl2br(e($footerSettings->working_hours)); ?></p>
                <?php endif; ?>
                <ul class="list-unstyled">
                ...
                <?php if($paymentMethods->count() > 0): ?>
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php else: ?>
                                <span class="badge bg-secondary"><?php echo e($method->name); ?></span>
                            <?php endif; ?>
                ...
                <?php if($footerSettings): ?>
                    <div class="mt-3">
                        ...
                        <div class="d-flex gap-3">
                            <?php if($footerSettings->social_facebook): ?>
                                <a href="<?php echo e($footerSettings->social_facebook); ?>" target="_blank" class="text-white-50"><i class="fab fa-facebook-f"></i></a>
                            <?php endif; ?>
                            <?php if($footerSettings->social_instagram): ?>
                                <a href="<?php echo e($footerSettings->social_instagram); ?>" target="_blank" class="text-white-50"><i class="fab fa-instagram"></i></a>
                            <?php endif; ?>
                            <?php if($footerSettings->social_youtube): ?>
                                <a href="<?php echo e($footerSettings->social_youtube); ?>" target="_blank" class="text-white-50"><i class="fab fa-youtube"></i></a>
                            <?php endif; ?>
                            <?php if($footerSettings->social_tiktok): ?>
                                <a href="<?php echo e($footerSettings->social_tiktok); ?>" target="_blank" class="text-white-50"><i class="fab fa-tiktok"></i></a>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endif; ?>
        ...
        <div class="row align-items-center">
            <div class="col-md-12 text-center">
                <p class="mb-0 small">
                    <?php if($footerSettings && $footerSettings->copyright_text): ?>
                        <?php echo e($footerSettings->copyright_text); ?>

                    <?php else: ?>
                        &copy; <?php echo e(date('Y')); ?> <strong>Fashion Shop</strong> - Thời Trang Cao Cấp. All rights reserved.
                    <?php endif; ?>
                </p>
            </div>
        </div>
...
</html><?php /**PATH D:\Boutique\fashion-shop\resources\views/layouts/app.blade.php ENDPATH**/ ?>