    ...
    <div class="container-fluid px-4">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('products.index')); ?>">Cửa Hàng</a></li>
                    ...
                    <?php if(auth()->user()->is_admin): ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end admin-dropdown-menu">
                                ...
                                <li><a class="dropdown-item admin-dropdown-item" href="<?php echo e(route('admin.users')); ?>"><i class="fas fa-users"></i> Quản Lý Tài Khoản</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li class="dropdown-header admin-section-header">
