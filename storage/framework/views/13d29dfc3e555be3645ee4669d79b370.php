...
unset($__errorArgs, $__bag); ?>
                ...
                <hr>
                <p class="text-center text-muted">Đã có tài khoản? <a href="<?php echo e(route('login')); ?>" class="text-primary fw-bold">Đăng nhập</a></p>
            </div>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Boutique\fashion-shop\resources\views/auth/register.blade.php ENDPATH**/ ?>