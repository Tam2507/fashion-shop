...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        name="type" 
                                        required>
                                    <option value="percentage" <?php echo e(old('type') === 'percentage' ? 'selected' : ''); ?>>Giảm theo %</option>
                                    <option value="fixed_amount" <?php echo e(old('type') === 'fixed_amount' ? 'selected' : ''); ?>>Giảm cố định</option>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="expires_at" 
                                       name="expires_at" 
                                       value="<?php echo e(old('expires_at', now()->addDays(30)->format('Y-m-d\TH:i'))); ?>"
                                       required>
