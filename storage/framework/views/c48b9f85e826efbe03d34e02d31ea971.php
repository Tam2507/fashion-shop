            ...
            <div class="message-content">
                <div class="message-bubble">
                    <?php if($message->image): ?>
                        <img src="/storage/<?php echo e($message->image); ?>" 
                             alt="Ảnh" 
                             style="max-width:220px; max-height:220px; border-radius:12px; display:block; cursor:pointer;"
                             onclick="window.open(this.src,'_blank')">
                    <?php endif; ?>
                    <?php if($message->message): ?>
                        <span style="<?php echo e($message->image ? 'display:block; margin-top:6px;' : ''); ?>"><?php echo e($message->message); ?></span>
                    <?php endif; ?>
                </div>
...
<div class="chat-input">
    ...
    <form action="<?php echo e(route('admin.messages.reply', $firstMessage->id)); ?>" method="POST" class="chat-input-form" enctype="multipart/form-data" id="adminReplyForm">
        <?php echo csrf_field(); ?>
...
async function submitMsg() {
    ...
    try {
        var res = await fetch('<?php echo e(route('admin.messages.reply', $firstMessage->id)); ?>', {
            method: 'POST',
            body: fd,
