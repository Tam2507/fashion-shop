...
<div class="container-fluid py-4">
    ...
    <div class="tab-content" id="adminTabsContent">
        ...
        <div class="tab-pane fade show active" id="products" role="tabpanel">
            <div class="card border-0 shadow-sm">
                <div class="card-header" style="background: #f5f1e8; border-bottom: 2px solid #8B3A3A;">
                    ...
                    <input type="text" id="searchProducts" class="form-control form-control-sm" placeholder="Tìm theo tên sản phẩm...">
                </div>
                <div class="card-body p-0">
                    <?php if($products->count()): ?>
                        <div class="table-responsive">
                            <table class="table table-hover mb-0" id="tableProducts">
        ...
        <div class="tab-pane fade" id="categories" role="tabpanel">
            <div class="card border-0 shadow-sm">
                <div class="card-header" style="background: #f5f1e8; border-bottom: 2px solid #8B3A3A;">
                    ...
                    <input type="text" id="searchCategories" class="form-control form-control-sm" placeholder="Tìm theo tên danh mục...">
                </div>
                <div class="card-body p-0">
                    <?php if($categories->count()): ?>
                        <div class="table-responsive">
                            <table class="table table-hover mb-0" id="tableCategories">
                                <thead style="background: #f9f7f4;">
                                    <tr>
                                        <th>ID</th>
                                        <th>Tên Danh Mục</th>
        ...
        <div class="tab-pane fade" id="orders" role="tabpanel">
            <div class="card border-0 shadow-sm">
                <div class="card-header" style="background: #f5f1e8; border-bottom: 2px solid #8B3A3A;">
                    <h5 class="mb-2"><i class="fas fa-shopping-cart me-2"></i>Quản Lý Đơn Hàng</h5>
                    <input type="text" id="searchOrders" class="form-control form-control-sm" placeholder="Tìm theo mã đơn, tên hoặc email khách...">
                </div>
                <div class="card-body p-0">
                    <?php if($orders->count()): ?>
                        <div class="table-responsive">
                            <table class="table table-hover mb-0" id="tableOrders">
                                <thead style="background: #f9f7f4;">
                                    <tr>
                                        <th>Mã ĐH</th>
                                        <th>Khách Hàng</th>
        ...
        <div class="tab-pane fade" id="users" role="tabpanel">
            <div class="card border-0 shadow-sm">
                <div class="card-header" style="background: #f5f1e8; border-bottom: 2px solid #8B3A3A;">
                    <h5 class="mb-2"><i class="fas fa-users me-2"></i>Quản Lý Khách Hàng</h5>
                    <input type="text" id="searchUsers" class="form-control form-control-sm" placeholder="Tìm theo tên hoặc email...">
                </div>
                <div class="card-body p-0">
                    <?php if($users->count()): ?>
                        <div class="table-responsive">
        ...
        <div class="tab-pane fade" id="admins" role="tabpanel">
            <div class="card border-0 shadow-sm">
                <div class="card-header" style="background: #f5f1e8; border-bottom: 2px solid #8B3A3A;">
                    ...
                    <input type="text" id="searchAdmins" class="form-control form-control-sm" placeholder="Tìm theo tên hoặc email...">
                </div>
                <div class="card-body p-0">
                    <?php if($admins->count()): ?>
                        <div class="table-responsive">
                            <table class="table table-hover mb-0" id="tableAdmins">
                                <thead style="background: #f9f7f4;">
                                    <tr>
                                        <th>ID</th>
                                        <th>Tên</th>
...
filterTable('searchProducts',   'tableProducts',   [2, 3]);
filterTable('searchCategories', 'tableCategories', [1, 2]);
filterTable('searchOrders',     'tableOrders',     [0, 1]);
filterTable('searchUsers',      'tableUsers',      [1, 2]);
filterTable('searchAdmins',     'tableAdmins',     [1, 2]);
</script>
