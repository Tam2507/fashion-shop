            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <p class="text-muted mb-0">
                        <i class="fas fa-box me-2"></i><?php echo e($wishlists->count()); ?> sản phẩm
                    </p>
                    <form method="POST" action="<?php echo e(route('wishlist.clear')); ?>" class="d-inline">
                        <?php echo csrf_field(); ?>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="card h-100 border-0 shadow-sm wishlist-card">
                    <div class="position-relative">
                        ...
                        <form method="POST" action="<?php echo e(route('wishlist.destroy', $product->id)); ?>" class="position-absolute top-0 end-0 m-2">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                    ...
                    <div class="card-body">
                        <p class="text-muted small mb-2">
                            <i class="fas fa-tag me-1"></i><?php echo e($product->category->name ?? 'Chưa phân loại'); ?>

                        </p>
                        <h5 class="card-title mb-2">
                            <a href="<?php echo e(route('products.show', $product->id)); ?>" class="text-dark text-decoration-none">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="h5 text-primary mb-0"><?php echo e(number_format($product->price, 0, ',', '.')); ?> ₫</span>
                            <?php
                            ...
                            <small class="text-muted">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <i class="fas fa-star <?php echo e($i <= round($avgRating) ? 'text-warning' : 'text-muted'); ?>" style="font-size:11px;"></i>
                                <?php endfor; ?>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <?php if($product->quantity > 0): ?>
                                ...
                                <?php else: ?>
                                    <form method="POST" action="<?php echo e(route('cart.add', $product->id)); ?>" class="add-to-cart-form-wishlist">
                                        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-footer bg-light border-0 text-muted small">
                        <i class="fas fa-clock me-1"></i>Đã thêm: <?php echo e($wishlist->created_at->diffForHumans()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Boutique\fashion-shop\resources\views/wishlist/index.blade.php ENDPATH**/ ?>