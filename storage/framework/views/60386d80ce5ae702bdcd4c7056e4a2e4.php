        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <div class="card-body text-white">
                        ...
                        <form id="uploadForm" enctype="multipart/form-data" data-product-id="<?php echo e($product->id); ?>">
                            <?php echo csrf_field(); ?>
                ...
                <div class="card border-0 shadow-sm mt-3">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <span class="badge bg-primary px-3 py-2"><?php echo e(ucfirst($color)); ?></span>
            ...
            <div class="col-lg-8">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <span class="badge bg-primary"><?php echo e($product->images->count()); ?> ảnh</span>
                </div>
                ...
                <div class="row g-3" id="currentImages">
                    ...
                    <div class="col-md-4 col-6" id="main-image-card">
                        <div class="image-card-modern">
                            <div class="image-wrapper-modern">
                                <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="Main Image">
                                <div class="image-badge-modern">
                                    <span class="badge bg-primary">Ảnh Chính</span>
                                </div>
                                <?php if($product->image_color): ?>
                                <div class="image-badge-modern" style="top: 8px; left: auto; right: 8px;">
                                    <span class="badge bg-success"><?php echo e(ucfirst($product->image_color)); ?></span>
                                </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="image-controls-modern">
                                <div class="d-flex gap-2 align-items-center">
                                    <select class="form-select form-select-sm main-image-color-select flex-grow-1">
                                        ...
                                        <?php $__currentLoopData = $availableColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($color); ?>" <?php echo e($product->image_color == $color ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-4 col-6" id="image-<?php echo e($image->id); ?>">
                        <div class="image-card-modern">
                            <div class="image-wrapper-modern">
                                <img src="<?php echo e(asset('storage/' . $image->path)); ?>" alt="Product Image">
                                
                                <!-- Delete Button (X đỏ ở góc) -->
                                <button type="button" class="delete-btn-corner" onclick="deleteImageQuick(<?php echo e($image->id); ?>)" title="Xóa ảnh">
                                    <i class="fas fa-times"></i>
                                </button>
                                
                                <?php if($image->color): ?>
                                <div class="image-badge-modern">
                                    <span class="badge bg-success"><?php echo e(ucfirst($image->color)); ?></span>
                                </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="image-controls-modern">
                                <div class="d-flex gap-2 align-items-center">
                                    <select class="form-select form-select-sm color-select flex-grow-1" data-image-id="<?php echo e($image->id); ?>">
                                        <option value="">-- Chọn màu --</option>
                                        <?php $__currentLoopData = $availableColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($color); ?>" <?php echo e($image->color == $color ? 'selected' : ''); ?>>
                                            <?php echo e(ucfirst($color)); ?>
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-primary custom-color-btn" data-image-id="<?php echo e($image->id); ?>" title="Thêm màu tùy chỉnh">
                                        <i class="fas fa-plus"></i>
                                    </button>
                                </div>
                            </div>
...
<?php /**PATH D:\Boutique\fashion-shop\resources\views/admin/products/partials/image-management.blade.php ENDPATH**/ ?>