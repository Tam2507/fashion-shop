...
<body>
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <ul class="nav-menu">
            <li><a href="<?php echo e(route('admin.home')); ?>" class="<?php echo e(request()->is('admin') ? 'active' : ''); ?>"><i class="fas fa-home"></i> Trang Chủ Admin</a></li>
            <li><a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e(request()->is('admin/dashboard') ? 'active' : ''); ?>"><i class="fas fa-chart-line"></i> Dashboard Thống Kê</a></li>
    ...
    <main class="admin-content">
        ...
        <div class="admin-header">
            <h1>
                <i class="<?php echo $__env->yieldContent('header_icon', 'fas fa-cogs'); ?>"></i>
