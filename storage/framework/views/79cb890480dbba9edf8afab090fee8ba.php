...
<?php $__env->startSection('page_title', 'Thêm Sản Phẩm Mới'); ?>
<?php $__env->startSection('header_icon', 'fas fa-plus-circle'); ?>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-8">
            ...
            <?php if(session('warning') && session('show_duplicate_confirm')): ?>
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <strong><i class="fas fa-exclamation-circle me-2"></i>Cảnh Báo Trùng Lặp:</strong>
                    <p class="mb-3 mt-2"><?php echo e(session('warning')); ?></p>
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.products.index')); ?>" class="btn btn-sm btn-secondary">
...
unset($__errorArgs, $__bag); ?>" 
                                           placeholder="Nhập tên sản phẩm" value="<?php echo e(old('name')); ?>" required />
...
unset($__errorArgs, $__bag); ?>" 
                                              rows="4" placeholder="Nhập mô tả chi tiết về sản phẩm"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                           placeholder="0" min="0" step="1000" value="<?php echo e(old('price', 0)); ?>" required />
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" id="seo_title" name="seo_title" class="form-control" 
                                   placeholder="Tiêu đề SEO (để trống sẽ dùng tên sản phẩm)" value="<?php echo e(old('seo_title')); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="seo_description" name="seo_description" class="form-control" rows="3" 
                                      placeholder="Mô tả SEO"><?php echo e(old('seo_description')); ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="meta_keywords" name="meta_keywords" class="form-control" 
                                   placeholder="từ khóa 1, từ khóa 2, từ khóa 3" value="<?php echo e(old('meta_keywords')); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Boutique\fashion-shop\resources\views/admin/products/create.blade.php ENDPATH**/ ?>