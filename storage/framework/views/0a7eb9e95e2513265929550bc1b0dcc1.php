            ...
            <div class="conversations-list" id="conversationsList">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="conversation-item" 
                         ...
                         data-user-id="<?php echo e($conversation->user_id); ?>"
                         data-guest-email="<?php echo e($conversation->guest_email); ?>"
                         data-name="<?php echo e($conversation->user ? $conversation->user->name : $conversation->guest_name); ?>"
                         data-email="<?php echo e($conversation->user ? $conversation->user->email : $conversation->guest_email); ?>"
                         data-avatar="<?php echo e($conversation->user && $conversation->user->avatar ? '/storage/' . $conversation->user->avatar : ''); ?>"
                         data-message="<?php echo e($conversation->message); ?>"
                         onclick="loadConversation(this)">
                        <?php if($conversation->user && $conversation->user->avatar): ?>
                            <img src="/storage/<?php echo e($conversation->user->avatar); ?>" 
                                 alt="<?php echo e($conversation->user->name); ?>" 
                        ...
                        <div class="conversation-info">
                            <div class="conversation-name">
                                <?php echo e($conversation->user ? $conversation->user->name : $conversation->guest_name); ?>

                            </div>
                            <div class="conversation-preview">
                                <?php echo e(Str::limit($conversation->message, 35)); ?>
                        ...
                        <div class="conversation-meta">
                            <div class="conversation-time">
                                <?php echo e($conversation->created_at->diffForHumans(null, true)); ?>

                            </div>
                            <?php if(!$conversation->is_read && !$conversation->is_admin_reply): ?>
...
<?php echo $__env->make('layouts.messenger', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Boutique\fashion-shop\resources\views/admin/messages/index.blade.php ENDPATH**/ ?>