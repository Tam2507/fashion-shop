...
<?php $__env->startSection('header_icon', 'fas fa-box'); ?>
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Tổng cộng: <strong><?php echo e($products->total()); ?> sản phẩm</strong></p>
        </div>
        <div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        <select name="status" class="form-select">
                            ...
                            <option value="in_stock" <?php echo e(request('status') == 'in_stock' ? 'selected' : ''); ?>>Còn hàng</option>
                            <option value="out_of_stock" <?php echo e(request('status') == 'out_of_stock' ? 'selected' : ''); ?>>Hết hàng</option>
                            <option value="low_stock" <?php echo e(request('status') == 'low_stock' ? 'selected' : ''); ?>>Sắp hết</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" class="form-check-input product-checkbox" value="<?php echo e($product->id); ?>" onchange="updateBulkActions()">
                                </td>
                                <td>
                                    <div class="product-image">
                                        ...
                                        ?>
                                        <?php if($displayImage): ?>
                                            <img src="<?php echo e(asset('storage/' . $displayImage)); ?>" alt="<?php echo e($product->name); ?>" class="rounded">
                                        <?php else: ?>
                                            <div class="no-image">
                                ...
                                <td>
                                    <div>
                                        ...
                                        <?php if($product->variants->count() > 0): ?>
                                            <div class="mt-1">
                                                <small class="badge bg-light text-dark"><?php echo e($product->variants->count()); ?> biến thể</small>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <span class="badge bg-<?php echo e($stockClass); ?>"><?php echo e($totalStock); ?></span>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        <a href="<?php echo e(route('products.show', $product->id)); ?>" class="btn btn-outline-info" title="Xem" target="_blank">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('admin.products.edit', $product->id)); ?>" class="btn btn-outline-primary" title="Sửa">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Boutique\fashion-shop\resources\views/admin/products/index.blade.php ENDPATH**/ ?>