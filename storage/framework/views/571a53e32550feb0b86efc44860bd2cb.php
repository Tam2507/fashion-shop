                ...
                <div class="card-body p-5">
                    ...
                    <div class="mb-4">
                        ...
                        <table class="table table-borderless">
                            <tr>
                                ...
                                <td class="text-end"><strong>#<?php echo e($order->id); ?></strong></td>
                            </tr>
                            <tr>
                                <td class="text-muted">Số tiền:</td>
                                <td class="text-end text-danger"><strong><?php echo e(number_format($order->total_price, 0, ',', '.')); ?> ₫</strong></td>
                            </tr>
                            <tr>
                    ...
                    <div class="text-center mb-4">
                        ...
                        <?php if(env('MOMO_STATIC_QR')): ?>
                            ...
                            <div class="my-4">
                                <img src="<?php echo e(env('MOMO_STATIC_QR')); ?>" alt="MoMo QR" class="img-fluid" style="max-width: 300px; border: 2px solid #a60f93; border-radius: 10px; padding: 10px;">
                                <p class="text-muted mt-2">
                                    <small>Quét mã QR bằng app MoMo<br>
                                    Số tiền: <strong class="text-danger"><?php echo e(number_format($order->total_price, 0, ',', '.')); ?> ₫</strong><br>
                                    Nội dung: <strong>DH<?php echo e($order->id); ?></strong></small>
                                </p>
                            </div>
                    ...
                    <div class="d-grid gap-3">
                        <form method="POST" action="<?php echo e(route('momo.demo.process')); ?>">
                            <?php echo csrf_field(); ?>
                        ...
                        <a href="<?php echo e(route('orders.show', $order)); ?>" class="btn btn-outline-secondary btn-lg w-100">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Boutique\fashion-shop\resources\views/momo/demo.blade.php ENDPATH**/ ?>