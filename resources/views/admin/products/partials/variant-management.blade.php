        ...
        <table class="table table-bordered align-middle" id="variantTable">
            ...
            <tbody id="variantTbody">
                ...
                <tr id="vrow-{{ $v->id }}" data-id="{{ $v->id }}">
                    ...
                    <td>
                        <button class="btn btn-sm btn-outline-primary btn-edit" onclick="startEdit(this)">Sua</button>
                        <button class="btn btn-sm btn-success btn-save d-none" onclick="saveRow(this)">Luu</button>
                        <button class="btn btn-sm btn-secondary btn-cancel d-none" onclick="cancelEdit(this)">Huy</button>
