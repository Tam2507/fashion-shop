        ...
        <div class="banner-container">
            <div class="banner-placeholder" style="background: linear-gradient(135deg, #8B3A3A 0%, #A8563A 50%, #6B4C40 100%);">
                <div class="banner-content">
                    ...
                    <a href="{{ route('products.index') }}" class="btn btn-cta">XEM SẢN PHẨM</a>
                </div>
            </div>
        </div>
    @endif
    ...
    @if($productSections->count() > 0)
        @foreach($productSections as $section)
            @if($section->products->count() > 0)
                <div class="mb-5 product-section" data-section-id="{{ $section->id }}">
                    ...
                    <div class="position-relative">
                        ...
                        @if($section->products->count() > 4)
                            <button class="carousel-nav carousel-nav-prev" onclick="window.slideSection({{ $section->id }}, -1); return false;">
                                <i class="fas fa-chevron-left"></i>
                            </button>
                            <button class="carousel-nav carousel-nav-next" onclick="window.slideSection({{ $section->id }}, 1); return false;">
                                <i class="fas fa-chevron-right"></i>
                            </button>
                        @endif
                        
                        <div class="products-carousel-wrapper">
                            <div class="products-carousel" id="carousel-{{ $section->id }}">
                                    ...
                                    <div class="product-overlay">
                                        ...
                                        @auth
                                            @if($product->quantity > 0)
                                                ...
                                                @else
                                                    <a href="{{ route('products.show', $product->id) }}" class="btn btn-dark py-2 px-3" style="border-radius: 0;">
                                                        <i class="fas fa-shopping-bag"></i>
                                                    </a>
                                                @endif
                                            @endif
                                        @else
                                            <button type="button" class="btn btn-primary btn-sm" onclick="alert('Vui lòng đăng nhập để thêm vào giỏ hàng!'); window.location.href='{{ route('login') }}'">
                                                <i class="fas fa-shopping-bag"></i>
                                            </button>
                                        @endauth
                                    </div>
